...
$ffi->attach( data => ['archive_write', 'opaque', 'size_t'] => 'ssize_t' );
$ffi->attach( data_block => ['archive_write', 'opaque', 'size_t', 'sint64'] => 'ssize_t' );
$ffi->attach( finish => ['archive_write'] => 'int' );
...
#$ffi->attach( open => ['archive_write', 'opaque', undef, undef, undef] => 'int' );
#$ffi->attach( open_FILE => ['archive_write', undef] => 'int' );
$ffi->attach( open_fd => ['archive_write', 'int'] => 'int' );
$ffi->attach( open_file => ['archive_write', 'string'] => 'int' );
...
$ffi->attach( set_compression_bzip2 => ['archive_write'] => 'int' );
$ffi->attach( set_compression_compress => ['archive_write'] => 'int' );
$ffi->attach( set_compression_gzip => ['archive_write'] => 'int' );
$ffi->attach( set_compression_lzip => ['archive_write'] => 'int' );
$ffi->attach( set_compression_lzma => ['archive_write'] => 'int' );
$ffi->attach( set_compression_none => ['archive_write'] => 'int' );
$ffi->attach( set_compression_program => ['archive_write', 'string'] => 'int' );
$ffi->attach( set_compression_xz => ['archive_write'] => 'int' );
