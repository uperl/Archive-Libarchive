...
$ffi->attach( gname_utf8 => ['archive_entry'] => 'string' );
$ffi->attach( hardlink_utf8 => ['archive_entry'] => 'string' );
...
$ffi->attach( pathname_utf8 => ['archive_entry'] => 'string' );
$ffi->attach( set_gname_utf8 => ['archive_entry', 'string'] => 'void' );
$ffi->attach( set_hardlink_utf8 => ['archive_entry', 'string'] => 'void' );
$ffi->attach( set_is_data_encrypted => ['archive_entry', 'char'] => 'void' );
$ffi->attach( set_is_metadata_encrypted => ['archive_entry', 'char'] => 'void' );
$ffi->attach( set_link_utf8 => ['archive_entry', 'string'] => 'void' );
$ffi->attach( set_pathname_utf8 => ['archive_entry', 'string'] => 'void' );
$ffi->attach( set_symlink_type => ['archive_entry', 'int'] => 'void' );
$ffi->attach( set_symlink_utf8 => ['archive_entry', 'string'] => 'void' );
$ffi->attach( set_uname_utf8 => ['archive_entry', 'string'] => 'void' );
$ffi->attach( symlink_type => ['archive_entry'] => 'int' );
$ffi->attach( symlink_utf8 => ['archive_entry'] => 'string' );
$ffi->attach( uname_utf8 => ['archive_entry'] => 'string' );
